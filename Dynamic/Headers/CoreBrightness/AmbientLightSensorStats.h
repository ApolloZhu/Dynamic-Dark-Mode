...
// //  NSLock, OS_dispatch_source;

__attribute__((visibility("hidden")))
@interface AmbientLightSensorStats
{
    CDStruct_93cb412c _activityFilteredStats;
    CDStruct_93cb412c _unfilteredStats;
    OS_dispatch_source *_reportTimer;
    unsigned long long _alsIdleEventStartTime;
    OS_dispatch_source *_alsIdleTimer;
    OS_dispatch_source *_userBrightnessTimer;
